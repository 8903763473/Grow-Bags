    ...
    doIshiTasks() {
        ...
        if (document.getElementsByClassName("ishi-progress-content").length) {
            ...
            if (stock > 0 && stock <= maxqty) {
                ...
                switch (stock) {
                    case 9:
                        progressSpan.style.width = "65%";
                        break;
                    case 8:
                        progressSpan.style.width = "60%";
                        break;
                    case 7:
                        progressSpan.style.width = "55%";
                        break;
                    case 6:
                        progressSpan.style.width = "50%";
                        break;
                    case 5:
                        progressSpan.style.width = "45%";
                        break;
                    case 4:
                        progressSpan.style.width = "30%";
                        break;
                    case 3:
                        progressSpan.style.width = "20%";
                        break;
                    case 2:
                        progressSpan.style.width = "10%";
                        break;
                    case 1:
                        progressSpan.style.width = "5%";
                        break;
                    default:
