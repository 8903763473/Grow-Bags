(() => {
    console.log('Script loaded:', 'b80cd6a5fw8efabb83pbabe92ddm0cb690eem.js');
    var e = {
        747: function (e, t, n) {
            var o, r, i;
            ! function (a, s) {
    ...
    n.amdO = {}, (() => {
        ...
        function Te(e) {
            return `${e || xe}-${function () {
                const e = "xxxx-4xxx-xxxx-xxxxxxxxxxxx"; let t = ""; try { const n = window.crypto, o = new Uint16Array(31); n.getRandomValues(o); let r = 0; t = e.replace(/[x]/g, (e => { const t = o[r] % 16; return r++, ("x" === e ? t : 3 & t | 8).toString(16) })).toUpperCase() } catch (n) { t = e.replace(/[x]/g, (e => { const t = 16 * Math.random() | 0; return ("x" === e ? t : 3 & t | 8).toString(16) })).toUpperCase() } return `
            $ {
                function() {
                    let e = 0,
                        t = 0;
        ...
        const Ie = "webPixelsManager",
            Oe = "production",
            Pe = "0.0.412",
            Le = "modern",
            Re = "80cd6a5fw8efabb83pbabe92ddm0cb690ee",
            De = "b80cd6a5fw8efabb83pbabe92ddm0cb690eem.js",
            Me = "loggedConversion2",
            je = "WebPixel::Render",
            $e = {
        ...
        const Ge = [];
        for (let n = 0; n < 256; ++n) Ge.push((n + 256).toString(16).slice(1));
        var Ke = function (e, t, n) {
            if (Be.randomUUID && !t && !e) return Be.randomUUID();
            const o = (e = e || {}).random || (e.rng || qe)();
            ...
            for (const n in e)
                if (Object.prototype.hasOwnProperty.call(e, n)) {
                    const o = n.replace(/[A-Z]/g, (e => `_${e}`)).toLowerCase(),
                        r = e[n];
                    t[o] = null !== r && "object" == typeof r ? tt(r) : r
                }
            return t
        }
        var nt = n(747);
        ...
        class it extends Error {
            constructor(...e) {
                super(...e), Error.captureStackTrace && Error.captureStackTrace(this, it)
            }
        }
        const at = {
                    ...
                    try {
                            ...
                            s = function (e) {
                                ...
                                const n = nt.parse(e).reduce(((e, t) => {
                                    const n = function ({
                                        ...
                                        var r;
                                        return {
                                            file: `https://cdn.shopify.com/cdn/wpm/${De}`,
                                            method: o,
                                            lineNumber: t,
                                            columnNumber: n
                                        }
                        ...
                        const c = function (t, {
                            ...
                            const {
                                ...
                                try {
                                    return new rt.UAParser(t).getResult()
                                } catch (e) {
                                    return {
                                        ua: "",
                                        browser: {
        ...
        class _t {
            ...
            subscribe(e, t, n = {}) {
                ...
                return this.channelSubscribers.set(e, o.set(t, n)), this.replayQueue.forEach((({
                    ...
                    this.eligibility(i, n, e) && (e === o || this.subscribeAllKey && e === this.subscribeAllKey) && t.call({}, {
                        ...r
                    })
                })), () => o.delete(t)
            }
        ...
        function Wt(e) {
            ...
            return {
                publish(n, o, i) {
                    ...
                    if (!Tt(n)) return !1;
                    if ("checkout_completed" === n && Ot() && -1 !== document.cookie.indexOf(`${Me}=1`)) return !1;
                    const d = Rt(o);
                            ...
                            "checkout_completed" === e && function () {
                                if (Ot()) {
                                    const e = self.location.pathname.split("/").slice(0, -1).join("/"),
                                        t = new Date(Date.now());
                                    t.setMonth(t.getMonth() + 2), document.cookie = `${Me}=1; expires=${t}; path=${e}`
                                }
                            }()
                        }(n), r || Ee() || (r = !0, m = e.shopId, h = e.surface || "unknown", Ft.add((() => function (e, t) {
                            Ut || (Ut = !0, wt("consentAccepted", {
                                version: Pe,
                                bundleTarget: Le,
                                shopId: e,
                                surface: t,
                ...
                publishDomEvent(e, t, n) {
                    if (!Et("web_pixels_dom_analytics")) throw new Yt("This feature is disabled");
                    if ("string" != typeof e) {
                ...
                subscribe(e, r, i = {}) {
                    ...
                    return e === zt ? n.subscribe(zt, a, i) : e === Kt || Tt(e) ? t.subscribe(e, a, i) : Et("web_pixels_dom_analytics") && (e === Ht || Nt(e)) ? o.subscribe(e, a, i) : n.subscribe(e, a, i)
                }
            }
        }
        ...
        function fn({
            ...
            return {
                analytics: {
                    subscribe: (r, a, s) => (i && rn(a), e.subscribe(r, a, {
                        ...s,
        ...
        async function kn({
            ...
            const {
                search: o
            } = self.location, r = t.id, i = [Ye(n), "/wpm", `@${Re}`, `/web-pixel-${r}`, `@${t.scriptVersion}`, "/sandbox", `/${Le}`, /\.(js|json|xml)$/.test(self.location.pathname) ? "" : self.location.pathname, o];
            if (n.match(/spin\.dev\/?/)) {
                const e = o.length ? "&" : "?";
            ...
            return function (e, {
                ...
                if (!t) {
                    const e = new it("src or srcdoc must be provided");
                    throw ct.notify(e, {
                ...
                if (r.setAttribute("src", t), r.setAttribute("id", e), r.setAttribute("name", e), r.setAttribute("sandbox", n.join(" ")), r.setAttribute("tabIndex", "-1"), r.setAttribute("aria-hidden", "true"), ! function (e) {
                    ...
                    const e = new it("browser does not support the sandbox attribute on IFrames");
                    throw ct.notify(e, {
                        context: "v0/createIframe",
                        unhandled: !1,
                        severity: "warning"
                ...
                return r.setAttribute("style", "display:none; height:0; width:0; visibility: hidden;"), await
                    function (e) {
                        return new Promise(((t, n) => {
                            ...
                            if (Et("web_pixels_manager_performance_improvement"))
                                if (document.body) o();
                                else {
                                    const e = () => {
        ...
        async function Ln({
            ...
            const a = `web-pixel-sandbox-${e.type}-${e.id}-${e.runtimeContext}-${Re}`;
            if (e.runtimeContext === qt.Lax && document.getElementById(a)) {
                const t = new Pn;
                return ct.notify(t, {
                    pixelId: e.id,
                    pixelType: e.type,
            ...
            switch (e.runtimeContext) {
                case qt.Strict:
                    [s, c] = await async function ({
                        sandboxId: e,
                        webPixelConfig: t,
                        storefrontBaseUrl: n
                    }) {
                        const o = t.id,
                            r = [Ye(n), "/wpm", `@${Re}`, `/web-pixel-${o}`, `@${t.scriptVersion}`, "/sandbox", `/worker.${Le}.js`];
                        n.match(/spin\.dev\/?/) && r.push("?fast_storefront_renderer=1");
                        const i = r.join(""),
                            a = new Worker(i, {
                                name: e,
                                type: "classic",
                            ...
                            s = new Promise(((e, t) => {
                                const n = () => {
                                    a.removeEventListener("error", n), t(new Error(`Failed to load web worker for pixel ${o} with url ${i}}`))
                                };
            ...
            const m = e.runtimeContext === qt.Lax ? Nn() : {
                localStorageItems: {},
                sessionStorageItems: {}
            };
            try {
                const t = [l.call.initialize({
                ...
                c && t.push(c), await Promise.race(t)
            } catch (h) {
                return !1
            }
            if (Re !== p.hashVersion) {
                const t = new Error(`The main bundle hash (${Re}) does not match the sandbox hash (${p.hashVersion})`);
                ct.notify(t, {
                    severity: "warning",
                    pixelId: e.id,
                    pixelType: e.type,
                    ...
                    hashVersionSandbox: p.hashVersion,
        ...
        async function Rn(e) {
            ...
            if (o.runtimeContext === qt.Open && !Et("web_pixels_manager_open_mode")) return !1;
            var l, u;
                    ...
                    try {
                        n = await async function ({
                            ...
                            const p = o.match(/spin\.dev\/?/),
                                m = [Ye(o), `/wpm@${Re}`, `/${e.type.toLocaleLowerCase()}`, `/web-pixel-${u}@${e.scriptVersion}`, `/pixel.${Le}.js`, p ? "?fast_storefront_renderer=1" : ""].join("");
                            if (!("createShopifyExtend" in (null !== (a = self[Ie]) && void 0 !== a ? a : {}))) {
                                const e = (e, t) => {
                                ...
                                Object.defineProperty(self, Ie, {
                                    value: {},
                                    enumerable: !0,
                                    writable: !1,
                                    configurable: !1
                                }), Object.defineProperty(self[Ie], "createShopifyExtend", {
                                    value: e,
                                    enumerable: !0,
                                    writable: !1,
                                    configurable: !1
        ...
        const Un = function () {
            ...
            try {
                const e = He();
                return i.payload.status = "loaded", bt(i), {
                    init(t) {
                        ...
                        ut(u),
                            function (e = []) {
                                (Array.isArray(e) ? e : [e]).forEach((e => yt.add(e)))
                            }(c);
                        const d = Ee().toString(),
                            f = Ue("unload", {
                                version: Pe,
                        ...
                        try {
                            ...
                            if (/^web-pixel-sandbox/.test(self.name)) {
                                const e = new it("WebPixelsManager: browser library is being run in a sandbox");
                                throw h.library = "browser", ct.notify(e, h), e
                            }
                            if (!n) {
                                const e = new it("WebPixelsManager: shopId is required");
                                throw ct.notify(e, h), e
                            }
                            if (!u) {
                                const e = new it("WebPixelsManager: storefrontBaseUrl is required");
                                throw ct.notify(e, h), e
                            }
                            if (!Xt(u)) {
                                const e = new it(`WebPixelsManager: storefrontBaseUrl is not a valid absolute URL: ${u}`);
                                throw ct.notify(e, h), e
                            }
                            if (!o) {
                                const e = new it("WebPixelsManager: cdnBaseUrl is required");
                                throw ct.notify(e, h), e
                            }
                            if (!Xt(o)) {
                                const e = new it(`WebPixelsManager: cdnBaseUrl is not a valid absolute URL: ${o}`);
                                throw ct.notify(e, h), e
                            }
                            "checkout-one-sdk" === i && (l = []);
                            const e = l.reduce(((e, t) => {
                                ...
                                return null !== (a = t.restrictions) && void 0 !== a && a.preventLoadingBeforeEvent ? e.waiting.push(c) : e.ready.push(c), e
                            }), {
                                ready: [],
                                waiting: []
                            });
                            ...
                            }(f))).catch((() => { })), Promise.all(e.waiting).catch((() => { })), "checkout-one" !== i && (w(m.publish, s), Et("web_pixels_dom_analytics") && function (e) {
                                const t = function () {
                                    let e = !1;
                                    try {
                                        const t = {
                            ...
                            const t = (g = {
                                ...
                                clientId: Mt(document.cookie)._shopify_y,
                                version: Pe,
                                customerId: null == s || null === (v = s.customer) || void 0 === v ? void 0 : v.id
                            }, {
                                visitor: (e, t) => function (e, t, n) {
                                    ...
                                    return Bt().then((() => wt("visitor", r))).catch((() => ct.notify("visitor error", {
                                        severity: "error",
                            ...
                            return y instanceof it || ct.notify(y, {
                                context: "v0/init",
                                shopId: n,
                                initConfig: t
                ...
                return s instanceof it || ct.notify(s, {
                    context: "v0/createWebPixelsManager"
                }), self.console && console.error(s), i.payload.status = "manager-create-error", i.payload.errorMsg = null == s ? void 0 : s.message, bt(i, !0), {
                    init: () => a
                }
            }
        }();
